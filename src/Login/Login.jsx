    ...
    <section className="border rounded-xl p-[25px] max-w-[500px] mx-auto mt-36 mb-24 shadow-md bg-slate-200">
      ...
      <form onSubmit={hendleForm}>
        <div className="flex flex-col my-4">
          <label htmlFor="email" className="text-[17px] font-semibold p-1">
            User-email
          </label>
          <input
            type="email"
        ...
        <div className="flex flex-col my-4">
          <label htmlFor="password" className="text-[17px] font-semibold p-1">
            Password
          </label>
          <input
            type="password"
        ...
        <button
          type="submit"
          className=" bg-lime-300 text-white w-full p-3 text-[21px] rounded mt-[10px]"
        >
          Login
        </button>
        ...
        <div className="flex gap-4 mb-7">
          ...
          <div
            ...
            className="p-[10px] bg-blue-200  cursor-pointer rounded w-full flex justify-center items-center gap-[6px] mt-[33px]"
          >
